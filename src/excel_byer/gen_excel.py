...
class Tables:
    ...
    def add_row(self, name, min_price, factory_new, minimal_wear, field_tested, well_worn, battle_scarred, link):
        if self.ws:
            self.ws.append([name, min_price, factory_new, minimal_wear, field_tested, well_worn, battle_scarred, link])
