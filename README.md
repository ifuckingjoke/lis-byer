# ![Logo](logo.gif) ![ExcelIcon](https://res.cdn.office.net/files/fabric-cdn-prod_20251117.001/assets/brand-icons/product/svg/excel_16x1.svg) Cкрипт для парсинга скинов и генерации XLSX таблиц

## ![Static Badge](https://img.shields.io/badge/OpenSource-❤️-pink)
![Static Badge](https://img.shields.io/badge/Language-Python-blue)
![GitHub Tag](https://img.shields.io/badge/Realese-v2.0.1-green)
...
⚠️ **Waring:** lis-byer не получает информацию о ваших браузерах, cookie, ссесиях. Скрипт использует предустановленые браузеры для работы playwright, автоматически создавая новую ссесию при запуске.
